...
var MagicZoom_ua='msie';var W=navigator.userAgent.toLowerCase();if(W.indexOf("opera")!=-1){
  ...
  this.popupSizeX=100;if(this.settings&&this.settings["header"]!=""){
    ...
    preload:function(){
        this.bigImg=document.createElement('images');this.addEvent(this.bigImg,'load',this.onImgLoad);this.initTimer=setTimeout(MagicTools.bind(function(){
    ...
    createControlBar:function(){
        this.controlbar=document.createElement("div");MagicTools.Element.setStyle(this.controlbar,{
            ...
            if('next'==buttons[i]&&MagicThumb.getLast(this.group)===this){
                ...
                'left':w,
                'cursor':'pointer'
            });cbA.appendChild(cbBgWrapper);var bgIMG=document.createElement('images');MagicTools.Element.setStyle(bgIMG,{
                'position':'absolute',
                'top':-999
    ...
    prepare:function(){
        function xgdf7fsgd56(vc67){
            ...
            'display':'block',
            'visibility':'hidden'
        });MagicTools.Element.addClass(this.cont,'MagicThumb-container');document.body.appendChild(this.cont);this.smallImg=this.anchor.getElementsByTagName('images')[0];if(!this.smallImg){
            this.smallImg=document.createElement('images');this.smallImg.src='data:image/gif;base64,R0lGODlhAQABAIAAACqk1AAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==';MagicTools.Element.setStyle(this.smallImg,{
                'width':0,
                'height':0,
                'opacity':0
